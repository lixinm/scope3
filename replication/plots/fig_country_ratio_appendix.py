#!/usr/bin/env python3
"""
fig_country_ratio_appendix.py — Appendix figure: ratio of EMRIO-based to
...
Paper reference: Appendix figure

Usage:
    python fig_country_ratio_appendix.py [--input INPUT_CSV] [--output OUTPUT_PDF]

Defaults:
    --input  ../output/figures/df_fig1_country_appendix_20240406.csv
    --output ../output/figures/fig_gS_compare_country_ratio_appendix.pdf
"""
import argparse
import os
import numpy as np
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate appendix country ratio comparison plot"
    )
    script_dir = os.path.dirname(os.path.abspath(__file__))
    default_input = os.path.join(
        script_dir, "..", "output", "figures", "df_fig1_country_appendix_20240406.csv"
    )
    default_output = os.path.join(
        script_dir, "..", "output", "figures", "fig_gS_compare_country_ratio_appendix.pdf"
    )
    ...
    # ---- Y-axis ticks (fixed labels, no forced ylim) ----
    predefined_ticks = [0.01, 0.1, 1, 10, 100, 1000, 10000, 100000]
